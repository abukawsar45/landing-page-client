...
const AllinOne = () => {
  ...
  return (
    <div className='flex flex-col md:flex-row justify-center items-center gap-2 md:gap-4 lg:gap-8 '>
      ...
      <div className='flex flex-col md:gap-2 lg:gap-4 md:justify-center w-full '>
        <div className='flex '>
          <div className='flex flex-col mt-[5%]  md:items-end gap-2 '>
            <p className='bg-[#EFD9F9] px-4 py-2 rounded-full rounded-br-none text-end'>
        ...
        <div className='flex mt-2 md:mt-4 lg:mt-12'>
          ...
          <div className='flex flex-col md:items-end gap-2 lg:-ml-64  lg:-mt-12'>
            <p className='bg-[#DDF3FF] px-4 py-2 rounded-full rounded-es-none text-end'>
              I got a perfect analysis rerport from them too
            </p>
            <p className='bg-[#DDF3FF] px-4 py-2 rounded-full rounded-br-none text-end'>
              Oh, that&apos;s great.
            </p>
          </div>
        </div>
